...
The following graph suggests that the quantity of items purchase is comparably consistent in two-year.The purchases reach a spike in week 27. Some obvious changes could be observed between week 32 and week 44.
...
Since most brands cover multiple commoditis, we picked two brands based on previous analysis to observe what other brands are frequently purchased with them together.
